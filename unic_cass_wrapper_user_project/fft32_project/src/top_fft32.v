...
wire signed [7:0] rx_data_re, rx_data_im;
wire              rx_valid;

wire signed [7:0] fft_out_re, fft_out_im;
wire              fft_out_valid;
wire              tx_ready;

wire signed [7:0] debug_mid_data_re;
...
// [0]:RX_Valid, [1]:FFT_Valid, [2]:TX_Ready, [3]:Inverse_Mode
